        ...
        do {
            ...
            switch (opcion) {
                case 1: {
                    ...
                    if (cola.estaLlena()) {
                        System.out.println("Error: La cola está llena (máximo 100 tareas). No se puede encolar " + tarea);
                    } else {
                        cola.insertar(tarea);
                ...
                case 3: {
                    if (cola.estaVacia()) {
                        ...
                        System.out.println("Tarea en frente: (no implementado)");
                    }
                    break;
                }
                case 4: {
                    if (cola.estaVacia()) {
                        ...
                        System.out.println("Estado: La cola tiene (no implementado) tarea(s).");
                    }
                    break;
                }
                case 0: {
